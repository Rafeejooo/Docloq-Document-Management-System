          ...
          {quickActions.map((action, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-base font-bold text-white mb-1">{action.name}</h3>
              ...
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-9 pr-4 py-2 text-sm rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 w-full sm:w-64"
                  />
                </div>
                <Link to="/documents">
                  <Button variant="ghost" size="sm">View All</Button>
