...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Gradient Orbs */}
      <motion.div
        className="absolute top-1/4 -left-32 w-96 h-96 bg-indigo-600/20 rounded-full blur-[120px]"
        animate={{
      ...
      />
      <motion.div
        className="absolute bottom-1/4 -right-32 w-96 h-96 bg-slate-600/20 rounded-full blur-[120px]"
        animate={{
          x: mousePosition.x * -0.5,
          y: mousePosition.y * -0.5,
        }}
            ...
            <div className="relative p-8 lg:p-10">
              ...
              <motion.form variants={itemVariants} onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-3.5 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder:text-slate-500 focus:outline-none focus:border-indigo-500/50 focus:ring-2 focus:ring-indigo-500/20 transition-all duration-200"
                      />
                    </div>
                  </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.99 }}
                  className="relative w-full py-3.5 px-6 bg-indigo-600 hover:bg-indigo-500 text-white font-medium rounded-xl transition-all duration-200 overflow-hidden group disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {/* Button shine effect */}
              ...
              <motion.div variants={itemVariants} className="relative my-8">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="px-4 text-slate-500 bg-slate-900/80">or continue with</span>
                </div>
              </motion.div>

              {/* Social Login */}
              <motion.div variants={itemVariants} className="grid grid-cols-2 gap-3">
                <button className="flex items-center justify-center gap-2 px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-slate-300 hover:bg-slate-800 hover:border-slate-600 transition-all duration-200">
